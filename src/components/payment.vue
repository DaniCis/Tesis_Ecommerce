...
<Toast />
 <div class="col-12 lg:col-6">
    ...
    <div class="rounded-md shadow-md bg-white grid p-2 mb-3">
                    ...
                    <div class="grid">
                        <div class="grid mb-3" >
                            ...
                            <div class="col-12 md:col-6">
                                ...
                                <InputNumber  v-model="v$.ident.$model" :useGrouping="false" @blur="verificarCliente(ident)" />
                                <div v-if="submitted">
                        ...
                        <div class="grid mb-3 " v-if="this.existe">
                            <div class="col-12 md:col-6">
                        ...
                        <div class="grid" v-if="this.existe">
                            <div class="col-12 md:col-6">
                        ...
                        <Button class="mt-3 w-full text-ceenter px-4 py-3 bg-blue-500 rounded-md shadow-md text-white font-semibold"  label="Confirmar Compra" ></Button>
                    </div>
                </form>
            </div>
            <div v-else>
                <form>
                    <div class="mb-4">
                        <div class="flex">
                            <label class="block text-600 font-medium mb-2">Nombre: 999999999</label>
                        </div>
                        <div class="flex">
                            <label class="block text-600 font-medium mb-2">Correo: 999999999</label>
                        </div>
                    </div>
                    <Button class="w-full text-ceenter px-4 py-3 bg-blue-500 rounded-md shadow-md text-white font-semibold"  label="Confirmar Compra" ></Button>
                </form>
            </div>
        </div>
    </div>
