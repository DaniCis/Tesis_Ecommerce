            ...
            <div class="mt-5 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-2 xl:space-y-0">
                <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div class="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                        ...
                        <div  v-for="product in this.detalles" :key="product.id_producto" class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                            ...
                            <div class="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-4 space-y-4 md:space-y-0">
                                ...
                                <div class="flex justify-between space-x-8 items-start w-full">
                                    ...
                                    <p class="text-base dark:text-white xl:text-lg leading-6 text-gray-800">{{product.cantidad_detalleVenta}}</p>
